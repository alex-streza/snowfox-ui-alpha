  ...
  <Story
    ...
    args={{
      ...
      children:
        ...
        '  ); \n' +
        '}; \n\n' +
        "const el = <Card title='Hello and welcome!' paragraph='To this snowfox' />\n"
    }}
  >
    {Template.bind({})}
  </Story>
...
<Codesandbox
  ...
  code={`
     <div sf-code editable="true" languages={['javascript']} theme="a11y-dark">const name = 'component';</div>`}
/>
...
<Codesandbox
  ...
  dependencies={{ 'highlight.js': '11.5.1' }}
  code={`
     <Code :editable="true" :languages="['javascript']" theme="a11y-dark">const name = 'component';</Code>`}
/>
...
<Codesandbox
  ...
  dependencies={{ 'highlight.js': '11.5.1' }}
  code={`<sf-code editable="true" languages="['javascript']" theme="a11y-dark">const name = 'component';</sf-code>`}
/>
